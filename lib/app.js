...
app.get('/motorcycles', async(req, res) => {
  const data = await client.query('SELECT * from motorcycles');
...
app.post('/motorcycles', async(req, res) => {
  ...
  VALUES($1, $2, $3, $4, $5, $6)
  RETURNING *
  `, [newMotorcycle.model, newMotorcycle.manufacturer, newMotorcycle.type, newMotorcycle.is_fast, newMotorcycle.ccs, fakeUser.id]);
